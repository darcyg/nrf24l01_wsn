...
char uart2_pbBuffer[UART2_FIFO_SIZE];
char *uart2_pbPut;
char *uart2_pbGet;

void uart2_FIFOInit(void)
{
    uart2_pbPut = uart2_pbBuffer;
    uart2_pbGet = uart2_pbBuffer;
}

void uart2_FIFOPut(char bInput)
{
    *uart2_pbPut = bInput;
    uart2_pbPut++;

    if (uart2_pbPut >= (uart2_pbBuffer + UART2_FIFO_SIZE))
        uart2_pbPut = uart2_pbBuffer;
}

char uart2_FIFOGet(void)
{
    char bReturn;
    bReturn = *uart2_pbGet;
    uart2_pbGet++;
    if (uart2_pbGet>= (uart2_pbBuffer + UART2_FIFO_SIZE))
        uart2_pbGet= uart2_pbBuffer;
    return bReturn;
}
...
{
    return !(uart2_pbPut == uart2_pbGet);
}
...
void UART2_pin_init()
{
//TRISBbits.TRISB7 = 0; // pin RB7 UART2 Tx
//TRISBbits.TRISB8 = 1; // pin RB7 UART2 Rx

#ifdef UART2_PIN_TX
    #if UART2_PIN_TX == 0
        #warning UART2_PIN_TX on RP0
        #ifdef PIN_IO_0
            #error PIN_IO_0 already used
        #else
            #define PIN_IO_0 1
            RPOR0bits.RP0R = 5;
        #endif
    #elif UART2_PIN_TX == 1
        #warning UART2_PIN_TX on RP1
        #ifdef PIN_IO_1
            #error PIN_IO_1 already used
        #else
            #define PIN_IO_1 1
            RPOR0bits.RP1R = 5;
        #endif
    #elif UART2_PIN_TX == 7
        #warning UART2_PIN_TX on RP7
        #ifdef PIN_IO_7
            #error PIN_IO_7 already used
        #else
            #define PIN_IO_7 1
            RPOR3bits.RP7R = 5;
        #endif
    #elif UART2_PIN_TX == 8
        #warning UART2_PIN_TX on RP8
        #ifdef PIN_IO_8
            #error PIN_IO_8 already used
        #else
            #define PIN_IO_8 1
            RPOR4bits.RP8R = 5;
        #endif
    #else
        #error UART2 config <UART2_PIN_TX> out of range
    #endif
#else
    #error UART2 config <UART2_PIN_TX> not defined
#endif

#ifdef UART2_PIN_RX
    #if UART2_PIN_RX == 0
        #warning UART2_PIN_RX on RP0
        #ifdef PIN_IO_0
            #error PIN_IO_0 already used
        #else
            #define PIN_IO_0 1
        ...
        #endif
    #else
        #error UART2 config <UART2_PIN_RX> out of range
    #endif
#else
    #error UART2 config <UART2_PIN_RX> not defined
#endif
}
