...
SOURCEFILES_QUOTED_IF_SPACED=app/src/main.c app/src/board_config.c common/src/logger.c common/src/device.c common/src/panic.s common/src/panic_handler.c common/src/spi.c drivers/src/pic24f_spi2.c drivers/src/pic24f_uart2.c drivers/src/nrf24l01.c drivers/src/pic24f_ext_irq.c drivers/src/pic24f_gpio.c drivers/src/pic24f_adc.c drivers/src/ir_control.c drivers/src/pic24f_i2c.c framework/mqtt/mqtt.c framework/serial/serial.c framework/tcp_app/tcp_server.c framework/uip/psock.c framework/uip/timer.c framework/uip/uip-fw.c framework/uip/uip-split.c framework/uip/uip.c framework/uip/uiplib.c framework/uip/nrf24l01_link.c os/croutine.c os/event_groups.c os/list.c os/queue.c os/tasks.c os/timers.c os/portable/MPLAB/PIC24_dsPIC/port.c os/portable/MPLAB/PIC24_dsPIC/portasm_PIC24.S os/portable/MemMang/heap_1.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/app/src/main.o ${OBJECTDIR}/app/src/board_config.o ${OBJECTDIR}/common/src/logger.o ${OBJECTDIR}/common/src/device.o ${OBJECTDIR}/common/src/panic.o ${OBJECTDIR}/common/src/panic_handler.o ${OBJECTDIR}/common/src/spi.o ${OBJECTDIR}/drivers/src/pic24f_spi2.o ${OBJECTDIR}/drivers/src/pic24f_uart2.o ${OBJECTDIR}/drivers/src/nrf24l01.o ${OBJECTDIR}/drivers/src/pic24f_ext_irq.o ${OBJECTDIR}/drivers/src/pic24f_gpio.o ${OBJECTDIR}/drivers/src/pic24f_adc.o ${OBJECTDIR}/drivers/src/ir_control.o ${OBJECTDIR}/drivers/src/pic24f_i2c.o ${OBJECTDIR}/framework/mqtt/mqtt.o ${OBJECTDIR}/framework/serial/serial.o ${OBJECTDIR}/framework/tcp_app/tcp_server.o ${OBJECTDIR}/framework/uip/psock.o ${OBJECTDIR}/framework/uip/timer.o ${OBJECTDIR}/framework/uip/uip-fw.o ${OBJECTDIR}/framework/uip/uip-split.o ${OBJECTDIR}/framework/uip/uip.o ${OBJECTDIR}/framework/uip/uiplib.o ${OBJECTDIR}/framework/uip/nrf24l01_link.o ${OBJECTDIR}/os/croutine.o ${OBJECTDIR}/os/event_groups.o ${OBJECTDIR}/os/list.o ${OBJECTDIR}/os/queue.o ${OBJECTDIR}/os/tasks.o ${OBJECTDIR}/os/timers.o ${OBJECTDIR}/os/portable/MPLAB/PIC24_dsPIC/port.o ${OBJECTDIR}/os/portable/MPLAB/PIC24_dsPIC/portasm_PIC24.o ${OBJECTDIR}/os/portable/MemMang/heap_1.o
...
# Source Files
SOURCEFILES=app/src/main.c app/src/board_config.c common/src/logger.c common/src/device.c common/src/panic.s common/src/panic_handler.c common/src/spi.c drivers/src/pic24f_spi2.c drivers/src/pic24f_uart2.c drivers/src/nrf24l01.c drivers/src/pic24f_ext_irq.c drivers/src/pic24f_gpio.c drivers/src/pic24f_adc.c drivers/src/ir_control.c drivers/src/pic24f_i2c.c framework/mqtt/mqtt.c framework/serial/serial.c framework/tcp_app/tcp_server.c framework/uip/psock.c framework/uip/timer.c framework/uip/uip-fw.c framework/uip/uip-split.c framework/uip/uip.c framework/uip/uiplib.c framework/uip/nrf24l01_link.c os/croutine.c os/event_groups.c os/list.c os/queue.c os/tasks.c os/timers.c os/portable/MPLAB/PIC24_dsPIC/port.c os/portable/MPLAB/PIC24_dsPIC/portasm_PIC24.S os/portable/MemMang/heap_1.c
